...
2. Подумайте, какую лабораторную работу из текущего семестра вы хотели бы сохранить в репозитории (по любому предмету).
3. Создайте репозиторий на GitHub.
4. Инициализируйте локальный репозиторий Git в папке с вашей лабораторной работой.
5. Скачайте и установите GitHub CLI.
...
6. Свяжите локальный репозиторий с удалённым репозиторием на GitHub. Команда для этого выглядит так:
   ```sh
   git remote add origin <url вашего репозитория>
   ```
7. Добавьте файлы лабораторной работы в индекс командой `git add *`, сделайте коммит.
...
10. Через веб-интерфейс GitHub создайте файл `README.md` и опишите в нём, что это за лабораторная работа, по какому предмету и что в ней реализовано.
