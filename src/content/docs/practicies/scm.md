...
3. В удобном месте на компьютере создайте папку `itm_2025`. Инициализируйте локальный репозиторий Git командой `git init` (Команду запускать из папки `itm_2025`).
