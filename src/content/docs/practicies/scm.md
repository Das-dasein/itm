...
3. В удобном месте на компьютере создайте папку `itm_2025`. Инициализируйте локальный репозиторий Git командой `git init`.
...
5. Свяжите локальный репозиторий с удалённым репозиторием на GitHub. Команда для этого выглядит так:
   ...
   ```
6. Добавьте в папку `itm-2025` схему алгоритма из первой практики (формат на ваш выбор: картинка, PDF).
